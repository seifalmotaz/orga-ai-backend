...
from src.lib.tools.tasks_tools import create_task, get_task_by_id, get_tasks_filtered, get_today_tasks
...
def get_day_after(
    ...
    - year: The current year.
    """
    date_to_return = date.today() + timedelta(months=after_months, days=after_days, hours=after_hours, minutes=after_minutes, seconds=after_seconds)
    return  {
